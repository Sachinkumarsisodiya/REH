          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-[1.15]">
                Book Eye Specialist <span className="text-teal-700">Consultation</span>
              </h1>
              <p className="text-slate-600 text-sm sm:text-base leading-relaxed max-w-xl">
                Choose your AIIMS-trained eye surgeon, select your preferred live time slot, and receive instant WhatsApp &amp; SMS confirmation with zero hospital waiting time.
              </p>
              ...
              <div className="grid grid-cols-3 gap-2 pt-3 border-t border-slate-200 max-w-lg">
                <div className="text-center sm:text-left">
                  <div className="text-lg sm:text-xl font-black text-slate-900">Instant</div>
                  <div className="text-[11px] text-slate-500 font-semibold">WhatsApp Pass</div>
                </div>
                <div className="text-center sm:text-left">
                  <div className="text-lg sm:text-xl font-black text-teal-700">Zero Wait</div>
                  <div className="text-[11px] text-slate-500 font-semibold">Priority Entry</div>
                </div>
                <div className="text-center sm:text-left">
                  <div className="text-lg sm:text-xl font-black text-slate-900">Free</div>
                  <div className="text-[11px] text-slate-500 font-semibold">Pre-Screening</div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative w-full max-w-md aspect-[16/10] sm:aspect-[16/11] rounded-3xl overflow-hidden shadow-2xl border-4 border-white group">
                <img
                  src="/images/banners/banner_booking.jpg"
                  alt="Senior Eye Specialist Consultation"
                ...
                <div className="absolute bottom-3 left-3 right-3 px-3.5 py-2 rounded-xl bg-white/95 backdrop-blur-md border border-white/40 flex items-center justify-between text-xs shadow-md">
                  <span className="font-bold text-slate-900 flex items-center space-x-1.5">
                    ...
                    <span>Verified Clinical Appointment</span>
                  </span>
                  <span className="text-teal-700 font-black text-[11px]">Instant Pass</span>
                </div>
              </div>
            </div>
