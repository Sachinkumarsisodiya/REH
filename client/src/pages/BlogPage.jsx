...
export default function BlogPage() {
  ...
  return (
    <div className="pt-28 pb-20 bg-slate-50 min-h-screen">
      ...
      {/* Header Banner */}
      <section className="bg-gradient-to-r from-slate-900 via-teal-950 to-slate-900 text-white py-16 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(#0d9488_1px,transparent_1px)] [background-size:16px_16px] opacity-15" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-4 text-center">
          <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-teal-500/20 text-teal-300 text-xs font-bold uppercase tracking-wider border border-teal-500/30">
            <BookOpen className="w-3.5 h-3.5 text-teal-400" />
            <span>Interactive Clinical Eye Health Hub</span>
          </div>
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black font-heading text-white tracking-tight">
            Doctor-Approved Eye Health &amp; Diagnostics
          </h1>
          <p className="text-slate-300 text-base sm:text-lg max-w-2xl mx-auto font-normal">
            Clinical guides, interactive self-screening tools, and ophthalmic first-aid protocols authored by <strong>Dr. Rekha Sisodiya</strong> and the REH surgical faculty.
          </p>
        </div>
      </section>
