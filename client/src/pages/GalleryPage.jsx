          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-5">
              <div className="flex items-center space-x-2.5">
                ...
                <span className="text-teal-800 font-extrabold uppercase tracking-wider text-xs sm:text-sm">
                  Hospital Tour &amp; Diagnostics
                </span>
              </div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-[1.15]">
                Infrastructure &amp; <span className="text-teal-700">Modular OT Tour</span>
              </h1>
              <p className="text-slate-600 text-sm sm:text-base leading-relaxed max-w-xl">
                Take a visual walkthrough of our Modular Laser Operation Theatres, HEPA Air Flow Systems, Diagnostic Lounges, and Premium Patient Recovery Suites.
              </p>
              ...
              <div className="grid grid-cols-3 gap-2 pt-3 border-t border-slate-200 max-w-lg">
                <div className="text-center sm:text-left">
                  ...
                  <div className="text-[11px] text-slate-500 font-semibold">Cleanroom OTs</div>
                </div>
                <div className="text-center sm:text-left">
                  <div className="text-lg sm:text-xl font-black text-teal-700">Zero</div>
                  <div className="text-[11px] text-slate-500 font-semibold">Infection Record</div>
                </div>
                <div className="text-center sm:text-left">
                  <div className="text-lg sm:text-xl font-black text-slate-900">NABH</div>
                  <div className="text-[11px] text-slate-500 font-semibold">National Certified</div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative w-full max-w-md aspect-[16/10] sm:aspect-[16/11] rounded-3xl overflow-hidden shadow-2xl border-4 border-white group">
                <img
                  src="/images/banners/banner_gallery.jpg"
                  alt="Modern Hospital Recovery Lounge & Surgical Suites"
                ...
                <div className="absolute bottom-3 left-3 right-3 px-3.5 py-2 rounded-xl bg-white/95 backdrop-blur-md border border-white/40 flex items-center justify-between text-xs shadow-md">
                  <span className="font-bold text-slate-900 flex items-center space-x-1.5">
                    ...
                    <span>Modular OTs &amp; Premium Suites</span>
                  </span>
                  <span className="text-teal-700 font-black text-[11px]">REH Campus</span>
                </div>
              </div>
            </div>
